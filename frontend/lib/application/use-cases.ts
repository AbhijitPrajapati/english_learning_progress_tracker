...
export const createGetDistribution =
  (analyticsGateway: AnalyticsGateway): GetDistribution =>
...
export const createGetTimeSeries =
  (analyticsGateway: AnalyticsGateway): GetTimeSeries =>
  async (timeframe: Timeframe, mistakeCategory: MistakeCategory) =>
...
export const createLogin =
  (authGateway: AuthGateway, sessionStore: SessionStore): Login =>
...
export const createRegister =
  (authGateway: AuthGateway): Register =>
  async (credentials: AuthCredentials) =>
    authGateway.register(credentials);

export type Logout = () => void;
export const createLogout =
  (sessionStore: SessionStore): Logout =>
  async () =>
    sessionStore.clearSession();

export type RestoreSession = () => AuthSession | null;
export const createRestoreSession =
  (sessionStore: SessionStore): RestoreSession =>
  () =>
    sessionStore.getSession();

export type UploadSpeech = (file: File) => Promise<Speech>;
export const createUploadSpeech =
  (speechGateway: SpeechGateway): UploadSpeech =>
  async (file: File) =>
    speechGateway.upload(file);
